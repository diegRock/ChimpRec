...
if __name__ == "__main__":
    # --- CONFIGURATION ---
    VIDEO_NAME = "20241019 - 14h29_v7_bytetrack_auto_clusteredv2"  # Change this for each video you evaluate!
    MODEL_VERSION = "v7_bytetrack_auto_clusteredv2"  # Change this when you improve the model!
