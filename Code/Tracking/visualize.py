...
if __name__ == "__main__":
    ...
    raw_video = "input/20241019 - 14h29.MP4"
    
    # Old Pipeline (Baseline)
    old_txt = "../../Metric/data/predictions/20241019 - 14h29-v2.txt"
    old_vid_out = "temp_baseline.mp4"
    
    # New Pipeline (Your Method)
    new_txt = "../../Metric/data/predictions/20241019 - 14h29_v7_bytetrack_auto_clusteredv2.txt"
    new_vid_out = "temp_ours.mp4"
    
    final_output = "Final_Comparison_SideBySide_14h29.mp4"

    # 2. RENDER INDIVIDUAL VIDEOS
    print("Rendering Baseline Video...")
    draw_tracks(raw_video, old_txt, old_vid_out, label_tag="Baseline (ByteTrack)")
    
    print("Rendering New Pipeline Video...")
    draw_tracks(raw_video, new_txt, new_vid_out, label_tag="Ours (ChimpUFE + Clustering)")

    # 3. COMBINE
    make_side_by_side(old_vid_out, new_vid_out, final_output)